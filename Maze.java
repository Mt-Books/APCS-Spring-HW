 ...
 *  1. Check if current position is a HERO, WALL, or VISITED_PATH
 *      a. If position is neither, move to step 2, otherwise, backtrack
 *  2. Recursively move a space (up, down, right, or left)
 *  3. Repeats steps 1 and 2 until EXIT is reached.
 ***/
